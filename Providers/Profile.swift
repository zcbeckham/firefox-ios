...
protocol Profile: class {
    var bookmarks: protocol<BookmarksModelFactorySource, ShareToDestination, SyncableBookmarks, ModifiableBookmarks, LocalItemSource, MirrorItemSource> { get }
...
public class BrowserProfile: Profile {
    ...
    lazy var bookmarks: protocol<BookmarksModelFactorySource, ShareToDestination, SyncableBookmarks, ModifiableBookmarks, LocalItemSource, MirrorItemSource> = {
